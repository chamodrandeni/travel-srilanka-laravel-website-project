...
@section('title', 'Add New Gallery Images')
...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-gallery')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control js-example-basic-single col-sm-12" name="category">
                                    ...
                                    @foreach ($imagecategory as $item)
                                        <option value="{{ $item->id }}">{{ $item->img_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
