...
@section('title', 'All Gallery Image')
        ...
        <div class="card">
            <div class="card-header  card-header--2">
                ...
                <form class="d-inline-flex">
                    <a href="{{ url('add-gallery') }}" class="btn btn-theme"> <i
                            ...
                            <tbody>
                                @foreach ($gallery as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->img_name}}</td>
                                        <td>
                                            <img src="{{ asset('assets/uploads/gallery/'.$item->gallary_image) }}" class="cate-image">
                                        </td>
                                        <td>
                                        <a href="{{ url('view-gallery/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('edit-gallery/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('delete-gallery/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
