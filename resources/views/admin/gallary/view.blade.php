        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    <div>
                        <h5>Gallery Image Details</h5>
                    </div>
                    <div>
                        <td>
                            <a href="{{ url('edit-gallery/'.$gallery->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-gallery/'.$gallery->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        ...
                                        <p class="bottom-space">{{ $gallery->img_name }}
                                        </p>
                                        <h6>Description</h6>
                                        <p class="bottom-space">{{ $gallery->description }}
                                        </p>
                                        <h6>Images</h6>
                                        <img src="{{ asset('assets/uploads/gallery/'.$gallery->gallary_image) }}" class="cate-image-view">
                                        <h6>Meta Keywords</h6>
                                        <p class="bottom-space">{{ $gallery->meta_keywords }}
                                        </p>
                                    </div>
                                </div>
                            </div>
