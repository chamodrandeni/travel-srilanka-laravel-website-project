...
@section('title', 'All Tour Plan Images')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header  card-header--2">
                ...
                <div>
                    <h5>All Tour Plan Image's</h5>
                </div>
                <form class="d-inline-flex">
                    <a href="{{ url('add-tourplanimage') }}" class="btn btn-theme"> <i
                ...
                <div>
                    <div class=" table-responsive table-desi">
                        <table class="all-cars-table table table-striped">
                            ...
                            <tbody>
                                @foreach ($tourplanimage as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->title }}</td>
                                        <td>
                                            <img src="{{ asset('assets/uploads/tourplanimage/'.$item->image) }}" class="cate-image">
                                        </td>
                                        <td>
                                        <a href="{{ url('view-tourplanimage/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('edit-tourplanimage/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('delete-tourplanimage/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
