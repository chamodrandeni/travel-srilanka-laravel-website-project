...
@section('title', 'Tour Plan Image Details')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    <div>
                        <h5>Tour plan Image's Details</h5>
                    </div>
                    <div>
                        <td>
                            <a href="{{ url('edit-tourplanimage/'.$tourplanimage->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-tourplanimage/'.$tourplanimage->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        <h6>Image Id</h6>
                                        <p>{{ $tourplanimage->id }}</p>
                                        <h6>Tour plan</h6>
                                        <p>{{ $tourplanimage->title }}
                                        </p>
                                        <h6>Images</h6>
                                        <img src="{{ asset('assets/uploads/tourplanimage/'.$tourplanimage->image) }}" class="cate-image-view">
                                    </div>
                                </div>
                            </div>
                        </div>
