...
@section('title', 'Add New Tour Plan Image')
...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-tourplanimage')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h5>Add New Tour plan Image</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" placeholder="Uplord Tour Plan Images" name="image">
                            </div>
                        </div>
