                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="mail">
                                        ...
                                        <div class="email"><a href="">{{ $email_sender }}</a></div>
                                        <div class="message"><p class="message-body">{{ $email_date }}</p></div>
                                        <div class="message"><p class="message-body">{{ $email_body }}</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
