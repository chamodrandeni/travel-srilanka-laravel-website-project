...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-imagecategory')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h5>Add New Image Category</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label-title">Category Name</label>
                                <input class="form-control" type="text" placeholder="Category name" name="img_name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control js-example-basic-single col-sm-12" name="tile">
                                    ...
                                    <option value="1">Tile 01(size:570x280)</option>
                                    <option value="2">Tile 02(size:270x280)</option>
                                    <option value="3">Tile 03(size:270x280)</option>
                                    <option value="4">Tile 04(size:270x280)</option>
                                    <option value="5">Tile 05(size:270x280)</option>
                                    <option value="6">Tile 06(size:570x280)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Uplord Thumbnail Images</label>
