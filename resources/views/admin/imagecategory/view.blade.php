...
@section('title', 'Image Category Details')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    ...
                    <div>
                        <td>
                            <a href="{{ url('edit-imagecategory/'.$imagecategory->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-imagecategory/'.$imagecategory->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        ...
                                        <h6>Name</h6>
                                        <p>{{ $imagecategory->img_name }}
                                        </p>
                                        <h6>Description</h6>
                                        <p class="bottom-space">{{ $imagecategory->description }}
                                        </p>
                                        <h6>Description</h6>
                                        <p class="bottom-space">{{ $imagecategory->tile }}
                                        </p>
                                        <h6>Description</h6>
                                        <p class="bottom-space">{{ $imagecategory->description }}
                                        </p>
                                        <h6>Images</h6>
                                        <img src="{{ asset('assets/uploads/imagecategory/'.$imagecategory->image) }}" class="cate-image-view">
                                    </div>
                                </div>
                            </div>
                        </div>
