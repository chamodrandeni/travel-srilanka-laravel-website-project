...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-testimonial')}}" method="POST">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Testimonial Name" name="name">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Message</label>
                                <textarea name="message" rows="3" class="form-control" placeholder="Enter Message"></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Aveter</label>
                                <input class="form-control" type="text" placeholder="Enter Aveter Link" name="aveter">
                            </div>
                            <div class="mb-3">
