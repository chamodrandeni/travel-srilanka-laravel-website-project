            ...
            <div class="card">
                <div class="card-header  card-header--2">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ url('add-testimonial') }}" class="btn btn-theme"> <i
                                ...
                                <tbody>
                                    @foreach ($testimonial as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <img src="{{ $item->aveter }}" class="cate-image">
                                            </td>
                                            <td>
                                                @if ($item->status == 1)
                                                    Active
                                                ...
                                                @endif
                                            <td>
                                            <a href="{{ url('view-testimonial/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                            <td>
                                            <a href="{{ url('edit-testimonial/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                            </td>
                                            <td>
                                            <a href="{{ url('delete-testimonial/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
