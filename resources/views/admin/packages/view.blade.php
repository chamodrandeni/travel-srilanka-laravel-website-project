        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    ...
                    <div>
                        <td>
                            <a href="{{ url('edit-package/'.$packages->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-package/'.$packages->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        ...
                                        <p class="bottom-space">{{ $packages->description }}
                                        </p>
                                        <h6>Package Images</h6>
                                        <img src="{{ asset('assets/uploads/package/'.$packages->image) }}" class="cate-image-view">
                                        <h6>Tour Type</h6>
                                        <p class="bottom-space">{{ $packages->name }}
                                        </p>
                                        <h6>Package Duration</h6>
                                        <p class="bottom-space">{{ $packages->duration }}
                                        </p>
                                        <h6>Status</h6>
                                        ...
                                        <h6>Feature</h6>
                                        <p class="bottom-space">
                                            @if ($packages->feature == 1)
                                                True
                                            @endif
                                            @if ($packages->feature == 0)
                                                False
                                            @endif
                                        </p>
                                    </div>
