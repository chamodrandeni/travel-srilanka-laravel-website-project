        ...
        <div class="card">
            <div class="card-header  card-header--2">
                ...
                <form class="d-inline-flex">
                    <a href="{{ url('add-packages') }}" class="btn btn-theme"> <i
                            ...
                            <tbody>
                                @foreach ($packages as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->packname }}</td>
                                        <td>
                                            <img src="{{ asset('assets/uploads/package/'.$item->image) }}" class="cate-image">
                                        </td>
                                        <td>{{ $item->name}}</td>
                                        <td>
                                        <a href="{{ url('view-package/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('edit-package/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('delete-package/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
