...
@section('title', 'Add New Packages')
...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-packages')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h5>Add New Package's</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label-title">Package Name</label>
                                <input class="form-control" type="text" placeholder="Enter Package Name" name="packname">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title  ">Package Description</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Package Duration" name="duration">
                            </div>
                            <div class="mb-3">
