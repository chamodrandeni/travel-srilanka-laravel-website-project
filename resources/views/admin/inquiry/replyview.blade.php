...
@section('title', 'Read and Reply Inquiry')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    <div>
                        <h5>Read and Reply Inquiry</h5>
                    </div>
                    <div>
                        <td>
                            <a href="{{ url('delete-inquiry/'.$inquiry->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="mail">
                                        ...
                                        <div class="email"><a href="">{{ $inquiry->email }}</a></div>
                                        <div class="message"><p class="message-body">{{ $inquiry->message }}</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="mail">
                                        <div class="name">
                                            <h1>Reply</h1>
                                            <p>{{ $inquirynew->created_at }}</p>
                                        </div>
                                        <div class="message"><p class="message-body">{{ $inquirynew->reply_message }}</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer text-end">
                    <div class="card-body">
                        <form class="theme-form mega-form" action="{{ url('insert-reply')}}" method="POST">
                            @csrf
                            <input type="text" name="inquiry_id" value="{{ $inquiry->id }}" hidden>
                            <div class="mb-3">
                                <input class="form-control" id="email" value="{{ $inquiry->email }}" name="email" placeholder="Email" type="email" required>
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" id="comments" name="reply_message" placeholder="Reply" rows="5"></textarea><br>
                            </div>
                            <div class="card-footer text-end">
                                <button class="btn btn-primary me-3" type="submit">Send Reply</button>
                            </div>
                        </form>
                    </div>
                </div>
