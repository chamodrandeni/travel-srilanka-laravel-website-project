            ...
            <div class="b-b-secondary border-5 border-0  card o-hidden">
                <div class=" custome-3-bg b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body p-0"><span class="m-0">Mails</span>
                ...
                <div class="card-body">
                    <div class="table-responsive ">
                        <table class=" dashboard-table table border-0 ">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{asset('backend/assets/images/tours/1.jpg')}}" alt="tour 1"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('backend/assets/images/tours/2.jpg')}}" alt="tour 2"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('backend/assets/images/tours/3.jpg')}}" alt=""></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('backend/assets/images/tours/4.jpg')}}" alt=""></td>
                        ...
                        <div class="w-100 dashboard-slider">
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/1.jpg')}}" alt=""
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/2.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/3.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/4.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/6.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
                            ...
                            <div class="category-box">
                                <div class="img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/5.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
                            ...
                            <div class="category-box">
                                <div class="ratio_40 img-category">
                                    ...
                                    <div class="img-category-box">
                                        <img src="{{asset('backend/assets/images/tours/7.jpg')}}" alt=""
                                            class="img-fluid bg-img ">
                                    </div>
                                    <div class="top-bar">
                                        <span class="offer">offer</span>
