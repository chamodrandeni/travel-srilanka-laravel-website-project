        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    ...
                    <div>
                        <td>
                            <a href="{{ url('edit-tourplan/'.$tour_plan->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-tourplan/'.$tour_plan->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        <h6>Tour Plan Id</h6>
                                        <p>{{ $tour_plan->id }}</p>
                                        <h6>Tour Plan Title</h6>
                                        <p>{{ $tour_plan->title }}
                                        </p>
                                        <h6>Package</h6>
                                        <p>{{ $tour_plan->packname }}
                                        </p>
                                        <h6>Tour Plan Description</h6>
                                        <p class="bottom-space">{{ $tour_plan->description }}
                                        </p>
                                        <h6>Status</h6>
                                        <p class="bottom-space">
                                            @if ($tour_plan->status == 1)
                                                Active
                                            @endif
                                            @if ($tour_plan->status == 0)
                                                Deactive
                                            @endif
                                        </p>
                                    </div>
