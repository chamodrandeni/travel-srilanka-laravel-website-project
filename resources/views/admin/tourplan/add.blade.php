...
@section('title', 'Add New Tour Plan')
...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('insert-tourplan')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h5>Add New Tour Plan</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label-title">Tour Plan Title</label>
                                <input class="form-control" type="text" placeholder="Enter Package Name" name="title">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" rows="3" placeholder="Enter Package Description" class="form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <label  class="form-label-title ">Tour Plan Status</label>
