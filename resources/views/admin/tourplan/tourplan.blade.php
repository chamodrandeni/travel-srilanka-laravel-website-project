    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header  card-header--2">
                ...
                <div>
                    <h5>All Tour plan's</h5>
                </div>
                <form class="d-inline-flex">
                    <a href="{{ url('add-tourplan') }}" class="btn btn-theme"> <i
                            ...
                            <tbody>
                                @foreach ($tour_plan as $item)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ url('view-tourplan/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('edit-tourplan/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('delete-tourplan/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
