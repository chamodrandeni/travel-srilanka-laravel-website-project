<div class="page-header">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper">
                        <a href="/" target="_blank">
                            ...
                            <img class="img-fluid white-logo" src="{{asset('backend/assets/images/logo/logo-white.png')}}" alt="logo">
                        </a>
                    </div>
                            ...
                            <ul class="chat-dropdown onhover-show-div">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{asset('backend/assets/images/user/1.jpg')}}" alt="user1">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{asset('backend/assets/images/user/2.jpg')}}" alt="user2">
                                        <div class="status-circle online"></div>
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{asset('backend/assets/images/user/4.jpg')}}" alt="user3">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            ...
                            <ul class="profile-dropdown onhover-show-div">
                                ...
                                onclick="event.preventDefault();
                                 ...
                                 {{ __('Logout') }}
                                 <i class="fas fa-sign-out-alt fa-sm fa-sm fa-fw mr-2 text-gray-400"></i>
                                </a>
            ...
            <div class="ProfileCard-realName">name</div>
                ...
                <script class="empty-template"
                    type="text/x-handlebars-template"><div class="EmptyMessage">Your search turned up 0 results. This most likely means the backend is down, yikes!</div>
                </script>
            </div>
        </div>
