        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    <div>
                        <h5>Booking Detail's</h5>
                    </div>
                    <div>
                        <td>
                            <a href="{{ url('delete-booking/'.$booking->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        ...
                                        <h6>Email</h6>
                                        <p class="bottom-space">{{ $booking->email }}
                                        </p>
                                        <h6>Phon Number</h6>
                                        <p class="bottom-space">{{ $booking->number }}
                                        </p>
                                        <h6>Package</h6>
                                        <p class="bottom-space">{{ $booking->packname }}</p>
                                        <h6>Adult</h6>
                                        <p class="bottom-space">{{ $booking->adult }} adult's</p>
                                        <h6>Child</h6>
                                        <p class="bottom-space">{{ $booking->child }} child's</p>
                                        <h6>Booking Date</h6>
                                        <p class="bottom-space">{{ $booking->date }}
                                        </p>
                                        <h6>Message</h6>
                                        <p class="bottom-space">{{ $booking->message }}
                                        </p>
                                    </div>
                                </div>
                            </div>
