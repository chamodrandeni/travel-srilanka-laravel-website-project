                            ...
                            <tbody>
                                @foreach ($booking as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->date }}</td>
                                        <td>
                                        <a href="{{ url('view-booking/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('delete-booking/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
