...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form mega-form" action="{{ url('update-setting/'.$setting->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-header">
                            <h5>Update Setting's</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label-title">Compeny Name</label>
                                <input class="form-control" type="text" value="{{ $setting->name }}" placeholder="Enter Compeny Name" name="name">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Compeny Address</label>
                                <textarea name="address" rows="3" class="form-control" placeholder="Enter Compeny Address">{{ $setting->address }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Compeny Email</label>
                                <input class="form-control" type="email" value="{{ $setting->email }}" placeholder="Enter Compeny Email" name="email">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Contact Number</label>
                                <input class="form-control" type="text" value="{{ $setting->number }}" placeholder="Enter Contact Number" name="number">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Map Link</label>
                                <textarea name="maplink" rows="3" class="form-control" placeholder="Enter Map Link">{{ $setting->maplink }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Compeny Facebook Account Link</label>
                                <input class="form-control" type="text" value="{{ $setting->facebook }}" placeholder="Enter Compeny Facebook Account Link" name="facebook">
                            </div>
                            <div class="mb-3">
                                <label class="form-label-title">Compeny Twitter Account Link</label>
                                <input class="form-control" type="text" value="{{ $setting->twitter }}" placeholder="Enter Compeny Twitter Account Link" name="twitter">
                            </div>
                        </div>
