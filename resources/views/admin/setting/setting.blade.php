            ...
            @foreach ($setting as $item)
                <div class="card">
                    <div class="card-header  card-header--2 package-card">
                        ...
                        <div>
                            <td>
                                <a href="{{ url('edit-setting/'.$item->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                            </td>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea rows="3" class="form-control" readonly>{{ $item->address }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-title">Compeny Email Address</label>
                            <input class="form-control" type="text" value="{{ $item->email }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-title">Contact Number</label>
                            <input class="form-control" type="text" value="{{ $item->number }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-title">Map</label>
                            <iframe src="{{ $item->maplink }}" width="500" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="form-control"></iframe>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-title">Compeny Facebook Account Link</label>
                            <input class="form-control" type="text" value="{{ $item->facebook }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label-title">Compeny Twitter Account Link</label>
                            <input class="form-control" type="text" value="{{ $item->twitter }}" readonly>
                        </div>
                    </div>
                </div>
            @endforeach
