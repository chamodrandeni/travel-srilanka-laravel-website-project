...
@section('title', 'Tour Type Details')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header  card-header--2 package-card">
                    <div>
                        <h5>Tour Type Details</h5>
                    </div>
                    <div>
                        <td>
                            <a href="{{ url('edit-tourtype/'.$tourtype->id)}}" class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                        </td>
                        <td>
                            <a href="{{ url('delete-tourtype/'.$tourtype->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                        </td>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="description-section tab-section">
                                    <div class="about-sec ">
                                        <h6>Id</h6>
                                        <p>{{ $tourtype->id }}</p>
                                        <h6>Tour Type Name</h6>
                                        <p>{{ $tourtype->name }}
                                        </p>
                                        <h6>Group Size</h6>
                                        <p class="bottom-space">{{ $tourtype->grouptype }} People's
                                        </p>
                                        <h6>Group Size</h6>
                                        <p class="bottom-space">{{ $tourtype->guidetype }} Guide's
                                        </p>
                                        <h6>Image Category</h6>
                                        <p class="bottom-space">{{ $tourtype->img_name }}
                                        </p>
                                    </div>
                                </div>
                            </div>
