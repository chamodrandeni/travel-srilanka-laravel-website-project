            ...
            <div class="card">
                <div class="card-header  card-header--2">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ url('add-tourtype') }}" class="btn btn-theme"> <i
                                ...
                                <tbody>
                                    @foreach ($tourtype as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>{{ $item->grouptype }} People's</td>
                                            <td>{{ $item->guidetype }} Guide's</td>
                                            <td>
                                            <a href="{{ url('view-tourtype/'.$item->id)}}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                            <td>
                                            <a href="{{ url('edit-tourtype/'.$item->id)}}" class="btn btn-light"><i class="fa-sharp fa-solid fa-pen-to-square" style="color: #3aa52c;"></i></a>
                                            </td>
                                            <td>
                                            <a href="{{ url('delete-tourtype/'.$item->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash" style="color: #d51010;"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
